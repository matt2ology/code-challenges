...
if __name__ == "__main__":
    ...
    print("===============================================")
    print("Writing tests for the solution...")
    print("===============================================")
    assert foo("cat", "dog") is True  # True (123 -> 123)
    assert foo("mom", "dad") is True  # True (121 -> 121)
    assert foo("talk", "look") is False  # False (1234 -> 1223)
    assert foo("mmo", "dad") is False  # False (112 -> 121)
